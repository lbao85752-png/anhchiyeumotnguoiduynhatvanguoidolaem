...
v0.new("<Color=Cyan>Welcome to ThienDucScript Hub<Color=/>"):Display();
wait(0.5);
...
v5.Window = function(v134, v135)
	...
	v170.Image = "http://www.roblox.com/asset/?id="   .. tostring(108610659764941) ;
	...
	v197.Text = "ThienDucScript Roblox Hub";
	v197.TextSize = 17;
...
v8.Image = "rbxassetid://108610659764941";
v8.Draggable = true;
...
local v67 = v66:T("Tab Trạng thái", "rbxassetid://10734984606");
local v68 = v66:T("Tab Tổng quan", "rbxassetid://10723407389");
local v69 = v66:T("Tab Cài đặt Khác", "rbxassetid://10734950309");
local v70 = v66:T("Tab Vật Phẩm", "rbxassetid://10734975692");
local v71 = v66:T("Tab Race & Mirage", "rbxassetid://10747372167");
local v72 = v66:T("Tab Sự Kiện Biển", "rbxassetid://10709761530");
local v73 = v66:T("Tab Local Player", "rbxassetid://10747373176");
local v74 = v66:T("Tab Thị giác", "rbxassetid://10723346959");
...
local v78 = v66:T("Tab Trái Ác Quỷ", "rbxassetid://10709761889");
		...
		if v63 then
			pcall(function()
				...
				elseif (v63 == "Super Attack") then
					v63 = 0.04;
				elseif (v63 == "Bao18cm Attack") then
					v63 = 0.02;
				end
			end);
		end
...
game:GetService("StarterGui"):SetCore("SendNotification", {
	Title = "Anhchiyeu1minhaimy hub",
	Text = "Loading...",
	Icon = "rbxthumb://type=Asset&id=76338007379791&w=150&h=150",
	Duration = 10
});
spawn(function()
	while wait() do
