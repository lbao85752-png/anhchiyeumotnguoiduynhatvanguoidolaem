        ...
        World3 = true
         ...
         if _G.SelectMaterial == "Radiactive Material" then
               ...
               MMon = "Factory Staff"
	            ...
	            MPos = CFrame.new(-105.889565, 72.8076935, -670.247986, -0.965929747, 0, -0.258804798, 0, 1, 0, 0.258804798, 0, -0.965929747)				SP = "Bar"
...
function TelePPlayer(P)
	...
	game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = P end
...
_G.Logo = "rbxassetid://76338007379791"

_G.NameHub = "Made By LyBaoCacTo18cm" -- à¸Šà¸·à¹ˆà¸­ Hub

_G.Title = "Bao Hub Script blox fruits" -- à¸„à¸³à¸­à¸˜à¸´à¸šà¸²à¸¢
...
Discord.BackgroundTransparency = 1 -- LÃ m cho ná»n trong suá»‘t
...
UICorner.Parent = ImageButton
  ...
  function functionitem:Slider(text, floor, min, max, de, callback)
    ...
    -- TÃ­nh toÃ¡n giÃ¡ trá»‹ khi kÃ©o slider
    ...
    -- Cáº­p nháº­t giÃ¡ trá»‹ khi thay Ä‘á»•i CustomValue
...
local Main = Window:Tab("Tổng Quan","14477284625")

local AutoQuest = Window:Tab("Vật phẩm, nhiệm vụ","11446859498")

local Events = Window:Tab("Sự Kiện Biển","10734941354")

local Racer = Window:Tab("Tộc V4 & Định Vị","10747372167")

local RaidFruit = Window:Tab("Raid & Trái cây","10734975692")

local Playerrss = Window:Tab("Dịch chuyển & PVP","10734910680")

local MiscShop = Window:Tab("Cửa hàng & Misc","10723434557")

local AutoStatus = Window:Tab("Thông tin Server","10709770317")
...
spawn(function()
    ...
    while wait() do
        ...
        if _G.CollectBerry then
            ...
            if NearestBush and NearestBerryName then
                ...
                -- Bay vÃ o trong bá»¥i cÃ¢y

                TP1(CFrame.new(BushCenter + Vector3.new(0, 2, 0)))

                task.wait(0.5)

                -- TÃ¬m object tháº­t sá»± lÃ  trÃ¡i berry (theo tÃªn attribute)

                local BerryPart = BushModel:FindFirstChild(NearestBerryName)

                if BerryPart and BerryPart:IsA("BasePart") then

                    -- Bay Ä‘áº¿n Ä‘Ãºng vá»‹ trÃ­ trÃ¡i berry

                    TP1(BerryPart.CFrame + Vector3.new(0, 1, 0)) -- bay hÆ¡i trÃªn trÃ¡i berry má»™t tÃ­

                    task.wait(0.3)

                    -- Nháº¥n E Ä‘á»ƒ nháº·t berry
   ...
   CakePrinceStatus = AutoFarm:Label("Check Cake Prince")
    ...
    task.spawn(function()
      ...
      CakePrinceStatus:Set("Prince King Spawned âœ…")
    ...
    while wait() do
        ...
        pcall(function()
            ...
            if game:GetService("ReplicatedStorage"):FindFirstChild(_G.SelectBoss) or game:GetService("Workspace").Enemies:FindFirstChild(_G.SelectBoss) then
                ...
                BossSpawn:Set("Status :Boss Spawn âœ…")

            else

                BossSpawn:Set("Status :Boss Not Spawn âŒ")
    ...
    while task.wait() do
        ...
        pcall(function()
            ...
            if _G.BringMonster and StartBring and PosMon then
                ...
                -- Set SimulationRadius má»™t láº§n
    ...
    while wait() do
        ...
        pcall(function()
            ...
            if game:GetService("ReplicatedStorage"):FindFirstChild("Diablo") or game:GetService("ReplicatedStorage"):FindFirstChild("Deandre") or game:GetService("ReplicatedStorage"):FindFirstChild("Urban") or game:GetService("Workspace").Enemies:FindFirstChild("Diablo") or game:GetService("Workspace").Enemies:FindFirstChild("Deandre") or game:GetService("Workspace").Enemies:FindFirstChild("Urban") then
               ...
               EliteHunter:Set("Elite Hunter Spawning âœ…")

            else

                EliteHunter:Set("Not Have Elite Hunter in Severs âŒ")
	...
	while wait() do
		...
		pcall(function()
		   ...
		   if game:GetService("ReplicatedStorage"):FindFirstChild("rip_indra True Form") or game:GetService("Workspace").Enemies:FindFirstChild("rip_indra") then
		      ...
		      RipIndra:Set("Rip Indra Spawning âœ…")

		   else

		      RipIndra:Set("Not Have Rip Indra in Severs âŒ")
       ...
       Items:Seperator("Auto Get Items")       
        ...
        SaberO = Items:Label("Check Boss Saber")
         ...
         task.spawn(function()
           ...
           SaberO:Set("Boss Saber Spawning âœ…")

            else

           SaberO:Set("Not Have Boss Saber âŒ")
    ...
    task.spawn(function()
     ...
     while wait() do
      ...
      if game.ReplicatedStorage:FindFirstChild("Thunder God") or game.Workspace.Enemies:FindFirstChild("Thunder God") then
         ...
         PoleStatus:Set("Pole Boss Spawning âœ…")

          else

         PoleStatus:Set("Not Have Pole Boss âŒ")
    ...
    while wait() do
        ...
        pcall(function()
            ...
            if game:GetService("Workspace").Map:FindFirstChild("PrehistoricIsland") then
                ...
                VolcanoSP:Set("Prehistoric island: Spawning âœ…")

            else

                VolcanoSP:Set("Prehistoric island: Not Spawning âŒ")
...
spawn(function()
  ...
  Kitsune = Events:Label("Check Kitsune island")
   ...
   spawn(function()
      ...
      Kitsune:Set('Kitsune Island Spawning âœ…')

        else

      Kitsune:Set('Kitsune Island Not Spawning âŒ' )
        ...
        pcall(function()
            ...
            while wait() do
                ...
                if game.Workspace._WorldOrigin.Locations:FindFirstChild('Mirage Island') then
                    ...
                    Mirragecheck:Set('Mirage Island is Spawning âœ…')

                else

                    Mirragecheck:Set('Mirage Island Not Spawn âŒ') 
    ...
    while wait() do
        ...
        pcall(function()
            ...
            if game.ReplicatedStorage.Remotes.CommF_:InvokeServer("CheckTempleDoor") then
                ...
                Pulllevel:Set("Pull Level: Done âœ…")

            else

                Pulllevel:Set("Pull Level: Done âŒ")
		...
		while wait() do
			...
			for i, v in pairs(game.Workspace:GetChildren()) do
				...
				if string.find(v.Name, "Fruit") then
					...
					FindFruit:Set("ðŸ Not Have Fruits");
...
UpdateClient1()
        ...
        pcall(function()
            ...
            while wait() do
                ...
                if game.Workspace._WorldOrigin.Locations:FindFirstChild('Mirage Island') then
                    ...
                    MiragaCheck:Set('Mirage Island is Spawning âœ…')

                else

                    MiragaCheck:Set('Mirage Island Not Spawn âŒ') 
  ...
  spawn(function()
    ...
    while wait() do
        ...
        pcall(function()
            ...
            if game:GetService("Workspace").Map:FindFirstChild("PrehistoricIsland") then
                ...
                PrehistoricCheck:Set("Prehistoric island: Spawning âœ…")

            else

                PrehistoricCheck:Set("Prehistoric island: Not Spawning âŒ")
   ...
   spawn(function()
      ...
      KitsuneCheck:Set('Kitsune Island Spawning âœ…')

        else

      KitsuneCheck:Set('Kitsune Island Not Spawning âŒ' )
